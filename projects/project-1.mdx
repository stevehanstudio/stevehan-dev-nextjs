---
title: Backjack Game
subtitle: Blackjack card game using vanilla javascript
slug: blackjack
image: ./images/blackjack.png
screenshot: ./images/blackjack-screenshot.png
date: "2019-08-11"
author: Steve Han
skills: ["Javascript","HTML","CSS"]
website: https://cocky-benz-f77e67.netlify.app/
github: https://github.com/stevehanstudio/blackjack-game
---

import { Link } from "next/link"

This is project was the final project of a course on javascript I took at CCSF.  The javascript was made using vanilla javascript.  Currently is mainly for desktop.
